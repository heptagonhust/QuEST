...
# endif
        ...
        for (indexUp = thisTask * sizeTask * 2; indexUp < thisTask * sizeTask * 2 + sizeTask; indexUp+=4) {
            ...
            betaImag_times_stateImagLo = _mm256_add_pd(
                betaImag_times_stateImagLo, betaReal_times_stateRealLo);

            res1 = _mm256_sub_pd(res1, betaImag_times_stateImagLo);
            // original SIMD code
            ...
            alphaImag_times_stateRealUp = _mm256_add_pd(
                alphaImag_times_stateRealUp, betaImag_times_stateRealLo);
            res2 = _mm256_add_pd(res2, alphaImag_times_stateRealUp);
            ...
            alphaReal_times_stateRealLo = _mm256_add_pd(
                alphaReal_times_stateRealLo, alphaImag_times_stateImagLo);
            res3 = _mm256_add_pd(res3, alphaReal_times_stateRealLo);
            ...
            betaImag_times_stateRealUp = _mm256_add_pd(
                betaImag_times_stateRealUp, alphaReal_times_stateImagLo);
            res4 = _mm256_add_pd(res4, betaImag_times_stateRealUp);
