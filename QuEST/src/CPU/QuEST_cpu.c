...
# endif
        ...
        for (indexUp = thisTask * sizeTask * 2; indexUp < thisTask * sizeTask * 2 + sizeTask; indexUp+=4) {
            ...
            res1 = _mm256_fnmadd_pd(betaRealSIMD, stateImagLoSIMD, res2);
            ...
            res1 = _mm256_fnmadd_pd(betaImagSIMD, stateImagUpSIMD, res3);
            // res3 = _mm256_sub_pd(res3,_mm256_mul_pd(betaImagSIMD,stateImagUpSIMD));
            res2 = _mm256_fmadd_pd(alphaRealSIMD, stateRealLoSIMD, res3);
            // res3 = _mm256_add_pd(res3,_mm256_mul_pd(alphaRealSIMD,stateRealLoSIMD));
            res2 = _mm256_fmadd_pd(alphaImagSIMD, stateImagLoSIMD, res3);
            ...
            res2 = _mm256_fmadd_pd(betaImagSIMD, stateRealUpSIMD, res4);
            // res4 = _mm256_add_pd(res4,_mm256_mul_pd(betaImagSIMD,stateRealUpSIMD));
            res2 = _mm256_fmadd_pd(alphaRealSIMD, stateImagLoSIMD, res4);
            // res4 = _mm256_add_pd(res4,_mm256_mul_pd(alphaRealSIMD,stateImagLoSIMD));
            res1 = _mm256_fnmadd_pd(alphaImagSIMD, stateRealLoSIMD, res4);
